#rm nohup.outhup python -u a3c.py &
...
with graph.as_default(), tf.Session() as sess:
	...
	if LSTM:
		global_network = AC3LSTM(num_actions, num_states, num_trainable_vars)
	else:
		global_network = AC3FF(num_actions, num_states, num_trainable_vars)
